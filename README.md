...
- **12 tools** — `validate_jdl`, `create_app_from_jdl`, `import_jdl`, `add_entity`, `add_relationship`, `set_option`, `info`, `project_commands`, `upgrade_advisor`, `generate_ci_cd`, `generate_deployment`, `run_jhipster`. ([reference](docs/04-tools.md))
